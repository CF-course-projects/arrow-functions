...
// When joe.scope() is called, 'this' refers to the current object instance

// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is called, 'this' refers to the window object

// 3. Explain why "this" is different when an arrow function is used.
// 'this' when used in a function declaration refers to the current object instance. 
// If the function expression is nested within a parent function initialized with a function declaration, 'this' inside the function expression refers to the same thing that 'this' refers to in the parent function. If the function expression is not nested within another function, 'this' refers to the window object
